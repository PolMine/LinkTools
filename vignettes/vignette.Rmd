...
germaparl_lp13_lp14 <- corpus("GERMAPARL") |>
  subset(lp %in% c(13, 14)) |>
  subset(role == "mp")
...
LTD <- LTDataset$new(textual_data = germaparl_lp13_lp14, 
                     ...
                     external_resource = btstammdaten::bt_stammdaten_enriched,
...
LTD$check_and_add_missing_values(check_for_groups = NULL,
                                 modify = TRUE, 
